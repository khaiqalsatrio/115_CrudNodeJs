...
router.get('/signup', (req, res) => {
    res.render('signup', {
        layout: 'layout/main-layout' // Menampilkan form registrasi menggunakan layout tertentu
    });
});
...
router.get('/login', (req, res) => {
    res.render('login', {
        layout: 'layout/main-layout' // Menampilkan form login dengan layout tertentu
    });
});
